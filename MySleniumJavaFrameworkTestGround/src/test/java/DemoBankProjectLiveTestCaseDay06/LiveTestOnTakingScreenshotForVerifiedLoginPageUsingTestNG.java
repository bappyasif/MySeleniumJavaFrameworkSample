package DemoBankProjectLiveTestCaseDay06;
...
public class LiveTestOnTakingScreenshotForVerifiedLoginPageUsingTestNG {
	...
	public static void CommencingLogin(String ID, String PD) throws InterruptedException {
		...
		System.out.println("Trying to Login Inside User Home Page");
		Thread.sleep(2000);
		...
		try {
			...
			System.out.println("Initiating Vefication Sequence Of User Home Page");
			...
			System.out.println("Calling TakingSnapshot");
			TakingSnapshot();
	...
	public static void TakingSnapshot() throws InterruptedException, IOException {
		...
		TakesScreenshot verifiedUserloginScreenShot = ((TakesScreenshot)webDriver);
		File userLoggedInScreenShot = verifiedUserloginScreenShot.getScreenshotAs(OutputType.FILE);
		String fileSaved = ("E:\\eclipse\\LiveTestCodeSamples\\Bank Demo\\VerifiedSuccessfulUserLoginScreenShot" +".png");
		FileUtils.copyFile(userLoggedInScreenShot, new File(fileSaved));
