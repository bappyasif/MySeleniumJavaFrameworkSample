...
public class MySolutionTestNGTestCase05 {
	...
	@Test
	public void CommencingTest05Day05() throws InterruptedException, IOException {
		...
		webDriver.findElement(By.cssSelector("#email_address")).sendKeys("asifuzzamanbappy+04@gmail.com");
