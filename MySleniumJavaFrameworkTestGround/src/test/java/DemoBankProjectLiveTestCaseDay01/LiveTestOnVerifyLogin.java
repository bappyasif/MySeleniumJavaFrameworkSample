...
public class LiveTestOnVerifyLogin {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		CommencingTestOnVerifyingLogin();
		
	}
	
	
	public static void CommencingTestOnVerifyingLogin() throws InterruptedException, IOException {
		...
		try {
			...
			String fileSaved = ("E:\\eclipse\\LiveTestCodeSamples\\Bank Demo\\userLoginSuccessfulScreenShot" +".png");
