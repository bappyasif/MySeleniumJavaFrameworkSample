...
public class LiveTestReOrderWorkingSet {
	...
	public static void CommencingTestOnReOrder() throws InterruptedException, IOException {

		// making webDriver ready for this task to initiate.
